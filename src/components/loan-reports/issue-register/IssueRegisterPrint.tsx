...
interface IssueRegisterPrintProps {
  printRef: React.RefObject<HTMLDivElement | null>;
  mappedList: IssueRegisterRow[];
      ...
      <table className="w-full border-collapse text-center text-[10px]">
        <thead>
          ...
          <tr className="bg-slate-100 font-bold border-b border-black">
            <th className="border border-black p-1.5">Sl.</th>
            <th className="border border-black p-1.5">Issue Date</th>
            <th className="border border-black p-1.5 text-left">Group</th>
            <th className="border border-black p-1.5">Mem No</th>
            <th className="border border-black p-1.5 text-left">Member</th>
            <th className="border border-black p-1.5 text-left">Guardian</th>
            <th className="border border-black p-1.5 text-left">Area</th>
            <th className="border border-black p-1.5 text-left">Scheme</th>
            <th className="border border-black p-1.5 text-right">Loan Amt</th>
            <th className="border border-black p-1.5 text-right">Instl Amt</th>
            <th className="border border-black p-1.5 text-right">Realisable</th>
            <th className="border border-black p-1.5 text-left">Guarantor</th>
            <th className="border border-black p-1.5 text-left">Under CO</th>
          </tr>
        </thead>
        <tbody>
          {mappedList.map((row) => (
            <tr key={row.sl} className="border-b border-black">
              ...
              <td className="border border-black p-1.5">{row.memberNo || "-"}</td>
              <td className="border border-black p-1.5 text-left">
                {row.memberName || "-"}
              </td>
              <td className="border border-black p-1.5 text-left">
...
export default IssueRegisterPrint;
