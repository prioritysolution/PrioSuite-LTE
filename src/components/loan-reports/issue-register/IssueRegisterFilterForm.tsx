...
import { IssueRegisterForm } from "@/container/loan-reports/issue-register/IssueRegisterType";
import { RootState } from "@/redux/store";

interface FilterFormProps {
  onFilter: (values: IssueRegisterForm) => void;
  loading?: boolean;
  form: UseFormReturn<IssueRegisterForm>;
  resetForm: () => void;
}

export function IssueRegisterFilterForm({
  onFilter,
  loading,
  form,
  resetForm,
  ...
  function onSubmit(values: IssueRegisterForm) {
    onFilter(values);
  }
...
export default IssueRegisterFilterForm;
