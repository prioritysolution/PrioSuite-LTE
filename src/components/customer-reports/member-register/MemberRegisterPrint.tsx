...
interface MemberRegisterPrintProps {
  printRef: React.RefObject<HTMLDivElement | null>;
  mappedList: MemberRegisterRow[];
    ...
    >
      ...
      <table className="w-full border-collapse text-center text-xs">
        <thead>
          ...
          <tr style={{ border: "none" }}>
            <td colSpan={8} style={{ border: "none", height: "16px" }}></td>
          </tr>

          <tr className="bg-slate-100 font-bold border-b border-black">
            <th className="border border-black p-2 w-[40px]">Sl.</th>
            <th className="border border-black p-2 text-left">Member No</th>
            <th className="border border-black p-2 text-left">Member Name</th>
            <th className="border border-black p-2 text-left">Guardian Name</th>
...
export default MemberRegisterPrint;
