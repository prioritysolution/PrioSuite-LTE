...
import { MemberRegisterForm } from "@/container/customer-reports/member-register/MemberRegisterType";
import { RootState } from "@/redux/store";

interface FilterFormProps {
  onFilter: (values: MemberRegisterForm) => void;
  loading?: boolean;
  form: UseFormReturn<MemberRegisterForm>;
  resetForm: () => void;
}

export function MemberRegisterFilterForm({
  onFilter,
  loading,
  form,
  resetForm,
  ...
  function onSubmit(values: MemberRegisterForm) {
    onFilter(values);
  }
...
export default MemberRegisterFilterForm;
