...
import { GroupRegisterForm } from "@/container/customer-reports/group-register/GroupRegisterType";
import { RootState } from "@/redux/store";

interface FilterFormProps {
  onFilter: (values: GroupRegisterForm) => void;
  loading?: boolean;
  form: UseFormReturn<GroupRegisterForm>;
  resetForm: () => void;
}

export function GroupRegisterFilterForm({
  onFilter,
  loading,
  form,
  resetForm,
  ...
  function onSubmit(values: GroupRegisterForm) {
    onFilter(values);
  }
...
export default GroupRegisterFilterForm;
